...
2. Screenshot with simulated time waveforms. Always display all inputs and outputs (display the inputs at the top of the image, the outputs below them) at the appropriate time scale!
   ...
   ![your figure](https://github.com/mirek01622/digital-electronic-1/blob/main/03-vivado/EDA.PNG)
https://www.edaplayground.com/x/JgPF
...
##LEDs
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { g_o[0] }]; #IO_L17P_T2_A14_D30_14 Sch=led[6]
set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS33 } [get_ports { g_o[1] }]; #IO_L18P_T2_A12_D28_14 Sch=led[7]
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { g_o[2] }]; #IO_L16N_T2_A15_D31_14 Sch=led[8]
```
